	...
	<table border=1>
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo $user->getOferta(); ?> </td>
				<td><a href="./actualizar_usuarios.php?dni=<?=$user->getDni();?>&accion=a" class="btn btn-warning">
				...
				Actualizar</a> </td>
				<td><a href="./administrar_usuarios.php?dni=<?=$user->getDni()?>&accion=e" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16" style="margin: 0 4px 4px 0">
